...
# Location of Avian BAM database (here I used a sample but it could be the whole)

# Read SHAPEFILE.shp from the current working dir (".")
...
lapply(incBuff, function(x) {
                    srBuff <-gBuffer(studyRegion, width=as.numeric(x))
